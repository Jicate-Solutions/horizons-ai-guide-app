...
export const entranceExams: EntranceExam[] = [
  ...
  },
  {
    ...
    duration: '3 hours',
    syllabus: [
      'Physics - 30 Questions (attempt 25) = 100 marks',
      'Chemistry - 30 Questions (attempt 25) = 100 marks',
      'Mathematics - 30 Questions (attempt 25) = 100 marks',
      '20 MCQs (+4/-1) + 10 Numerical (+4/0, attempt 5)',
      'Total: 75 attempted | 300 Marks',
    ],
    eligibility: [
      '12th pass with PCM',
  ...
  },
  {
    ...
    syllabus: [
      ...
      'Each paper ~54 Questions, ~180-360 Marks (varies yearly)',
      'Topics: Class 11-12 NCERT + Advanced conceptual problems',
      '+4/-1 (MCQ), +4/0 (Numerical) — Partial marking available',
    ],
    eligibility: [
