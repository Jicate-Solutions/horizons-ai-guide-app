...
export const entranceExams: EntranceExam[] = [
  ...
  },
  {
    ...
    syllabus: [
      ...
      'Quantitative Techniques – ~14 Q (Ratios, proportions, basic algebra, mensuration – 10th level)',
  ...
  },
  {
    ...
    duration: '1.5 hours',
    syllabus: [
      'English Language (incl. Comprehension)',
      'General Knowledge & Current Affairs',
      'Legal Aptitude',
      'Logical Reasoning',
      'Mathematics',
      'Total: 150 MCQs | 150 Marks | -0.25 Negative Marking',
    ],
    eligibility: [
      '12th pass any stream',
  ...
  },
  {
    ...
    syllabus: [
      'Reading Comprehension — Passages + inference questions',
      'Analytical Reasoning — Logic puzzles, grouping, sequencing',
      'Logical Reasoning (2 sections) — Arguments, assumptions, strengthen/weaken',
      'No GK, no Maths, no Legal knowledge required',
      'Focus: Critical thinking & reasoning skills only',
      'No negative marking',
    ],
    eligibility: [
      '12th pass any stream',
  ...
  },
  {
    ...
    syllabus: [
      ...
      'Legal Reasoning',
      'General Knowledge',
      '60 MCQs | 60 Marks | No Negative Marking',
    ],
    eligibility: [
      '12th pass any stream',
      'Minimum 45% marks',
