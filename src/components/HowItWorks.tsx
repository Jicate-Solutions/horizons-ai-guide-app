...
const steps = [
  {
    ...
    description: 'Sign up with your mobile number. Takes less than 2 minutes.',
  ...
  },
  {
    ...
    description: 'Answer simple questions about your interests. Our AI finds the best career for you.',
  ...
  },
  {
    ...
    description: 'Get your personal career plan — colleges, courses, exams, and scholarships.',
