...
const counsellings: CounsellingInfo[] = [
  ...
  {
    id: 'tn-pharmacy',
    name: 'TN Pharmacy Counselling (B.Pharm / Pharm.D)',
    nameTamil: 'தமிழ்நாடு மருந்தியல் கலந்தாய்வு',
    icon: '💊',
    color: 'text-teal-700',
    bg: 'bg-teal-50',
    border: 'border-teal-200',
    authority: 'Selection Committee, Directorate of Medical Education (DME), Tamil Nadu',
    forWhom: 'B.Pharm (4 years) and Pharm.D (6 years) admission in TN government & self-financing pharmacy colleges affiliated to Dr. M.G.R. Medical University',
    eligibility: '12th Pass with Physics, Chemistry + Mathematics OR Biology. Min 50% in PCM/PCB (relaxation for SC/ST/MBC/BC). TN nativity. Age 17+ on 31 Dec of the admission year (max 30 for General, 35 for reserved).',
    fee: '₹1,000 application fee (online). Plus separate counselling processing fee per round.',
    applyLink: 'https://tnmedicalselection.net',
    officialSite: 'https://tnmedicalselection.net',
    tentativeDates: [
      { event: 'Online Application Opens', date: 'June 2026 (after HSC results)' },
      { event: 'Last Date to Apply', date: 'July 1st week, 2026' },
      { event: 'Document Verification (online)', date: 'July 2nd week, 2026' },
      { event: 'Provisional Rank List Release', date: 'July 3rd week, 2026' },
      { event: 'Online Counselling Round 1', date: 'August 1st-2nd week, 2026' },
      { event: 'Round 2 / Stray Vacancy', date: 'August-September, 2026' },
    ],
    steps: [
      { step: 1, title: 'Online Registration', description: 'Visit tnmedicalselection.net → Register with valid email & mobile → Fill personal, academic and community details → Pay ₹1,000 application fee online (debit/credit card, net banking, UPI).' },
      { step: 2, title: 'Upload Documents', description: 'Upload scanned copies of 12th marksheet, community certificate, nativity certificate, Aadhar, etc. Online verification — no need to visit in person.' },
      { step: 3, title: 'Merit Rank Calculation', description: 'There is NO entrance exam. Ranking is based on marks in the prescribed science subjects in HSC, reduced to a base of 200. For PCB students this gives full eligibility for B.Pharm + Pharm.D; PCM students are eligible for B.Pharm only.' },
      { step: 4, title: 'Rank List Publication', description: 'Provisional rank list published on tnmedicalselection.net. Check your overall rank and community rank carefully.' },
      { step: 5, title: 'Online Choice Filling', description: 'Login during your allotted slot → Browse the seat matrix → Add colleges and courses (B.Pharm / Pharm.D) in your preference order → Lock choices using OTP.' },
      { step: 6, title: 'Seat Allotment', description: 'Single-window allotment based on rank + choices + reservation. Options: Accept & report, Accept with upward movement, or Decline.' },
      { step: 7, title: 'Report to College', description: 'Visit allotted college with original documents within the deadline → Pay college fees → Confirm admission.' },
    ],
    importantNotes: [
      'NO entrance exam — admission is purely merit-based on 12th science marks',
      'Formula: Science subjects (Phy + Chem + Maths/Biology) reduced to a base of 200',
      'B.Pharm: 4 years | Pharm.D: 6 years (including 1-year internship)',
      'Pharm.D eligibility is stricter — PCB compulsory in most years',
      'Reservation per TN policy: BC 26.5%, BC-Muslim 3.5%, MBC 20%, SC 15%, SC-A 3%, ST 1%, plus 7.5% Govt School Quota',
      'Govt pharmacy fees: ₹15,000-25,000/year. Self-financing: ₹50,000-1.5 Lakh/year',
      'Discontinuation after the cut-off date carries a ₹1,00,000 penalty',
    ],
    documentsRequired: [
      '12th HSC Mark Sheet (with PCM/PCB)',
      'Community Certificate (if applicable)',
      'Nativity / Residence Certificate',
      'Income Certificate',
      'Aadhar Card',
      'Transfer Certificate from school',
      'Conduct Certificate',
      'Hepatitis-B vaccination certificate (before joining)',
      '4 passport-size photos',
    ],
  },
  {
    id: 'tn-nursing',
    name: 'TN Nursing Counselling (B.Sc Nursing)',
    nameTamil: 'தமிழ்நாடு செவிலியர் கலந்தாய்வு',
    icon: '🩺',
    color: 'text-rose-700',
    bg: 'bg-rose-50',
    border: 'border-rose-200',
    authority: 'Selection Committee, Directorate of Medical Education (DME), Tamil Nadu — affiliated to Dr. M.G.R. Medical University',
    forWhom: 'B.Sc Nursing (4 years) admission in TN government nursing colleges and government-quota seats in self-financing nursing colleges affiliated to Dr. M.G.R. Medical University',
    eligibility: '12th Pass with Physics, Chemistry, Biology (PCB). Min 45% aggregate (40% for SC/ST/MBC/BC). Both male and female candidates eligible (per latest INC norms). Age 17+ as on 31 Dec. TN nativity required.',
    fee: '₹400 application fee (online).',
    applyLink: 'https://tnmedicalselection.net',
    officialSite: 'https://tnmedicalselection.net',
    tentativeDates: [
      { event: 'Online Application Opens', date: 'June-July 2026 (after HSC results)' },
      { event: 'Last Date to Apply', date: 'July 2026' },
      { event: 'Document Verification (online)', date: 'July-August 2026' },
      { event: 'Provisional Rank List Release', date: 'August 2026' },
      { event: 'Online Counselling Round 1', date: 'August-September 2026' },
      { event: 'Round 2 / Mop-up Round', date: 'September-October 2026' },
    ],
    steps: [
      { step: 1, title: 'Online Registration', description: 'Visit tnmedicalselection.net → Register and fill the application form → Upload required documents → Pay ₹400 application fee.' },
      { step: 2, title: 'Document Verification', description: 'Online verification of HSC marksheet, community certificate, nativity, and INC-prescribed medical fitness. No personal visit usually needed.' },
      { step: 3, title: 'Merit Rank Calculation', description: 'NO entrance exam. Tamil Nadu does not conduct an entrance for B.Sc Nursing. Ranking is purely on HSC PCB marks (Physics + Chemistry + Biology) reduced to a base of 200.' },
      { step: 4, title: 'Rank List Publication', description: 'DMER releases the merit list on tnmedicalselection.net — both overall and community-wise.' },
      { step: 5, title: 'Online Choice Filling', description: 'Login during the counselling slot → Add government colleges and self-financing colleges (govt quota) in preference order → Lock with OTP.' },
      { step: 6, title: 'Seat Allotment', description: 'Single-window allotment based on rank + choices + reservation roster. Accept & report, or wait for next round.' },
      { step: 7, title: 'Report to College', description: 'Carry original documents and joining fee → Report to allotted college within the deadline (typically 3-5 days).' },
    ],
    importantNotes: [
      'TN does NOT conduct any entrance exam for B.Sc Nursing — pure merit',
      'Eligibility requires Biology — PCM-only students are NOT eligible',
      'Formula: PCB marks reduced to a base of 200',
      'Both genders are eligible (court orders have removed earlier female-only restriction)',
      'Govt nursing fees: ~₹10,000-20,000/year. Self-financing: ₹40,000-90,000/year',
      'Strong career path — INC-recognised degree opens up govt jobs and overseas opportunities (NCLEX-RN for USA, HAAD/DHA for Gulf)',
      'Separate counselling exists for Diploma in Nursing (GNM) — different process',
    ],
    documentsRequired: [
      '12th HSC Mark Sheet (with PCB)',
      'Community Certificate (if applicable)',
      'Nativity / Residence Certificate',
      'Income Certificate',
      'Aadhar Card',
      'Transfer Certificate from school',
      'INC-prescribed Medical Fitness Certificate',
      'Hepatitis-B vaccination certificate (before joining)',
      '4 passport-size photos',
    ],
  },
  {
    id: 'tn-paramedical',
    name: 'TN Paramedical & Allied Health Counselling',
    nameTamil: 'தமிழ்நாடு துணை மருத்துவம் கலந்தாய்வு',
    icon: '🔬',
    color: 'text-cyan-700',
    bg: 'bg-cyan-50',
    border: 'border-cyan-200',
    authority: 'Selection Committee, Directorate of Medical Education (DME), Tamil Nadu',
    forWhom: 'Paramedical / Allied Health degree courses — BPT (Physiotherapy), B.Sc MLT (Medical Lab Technology), B.Sc Radiology, B.Sc Optometry, B.Sc Anaesthesia Tech, B.Sc OT Tech, B.ASLP, B.Sc Cardiac Care, etc. in TN govt and self-financing colleges.',
    eligibility: '12th Pass with Physics, Chemistry, Biology (PCB). Min 50% aggregate (45% for SC/ST/MBC/BC). PCM students may be eligible for B.Optometry / B.ASLP per the prospectus. TN nativity required.',
    fee: '₹500-1000 application fee (online), depending on the course group.',
    applyLink: 'https://tnmedicalselection.net',
    officialSite: 'https://tnmedicalselection.net',
    tentativeDates: [
      { event: 'Online Application Opens', date: 'July 2026 (after HSC results)' },
      { event: 'Last Date to Apply', date: 'August 2026' },
      { event: 'Provisional Rank List Release', date: 'August-September 2026' },
      { event: 'Online Counselling Round 1', date: 'September 2026' },
      { event: 'Round 2 / Stray Vacancy', date: 'October-November 2026' },
    ],
    steps: [
      { step: 1, title: 'Online Registration', description: 'Visit tnmedicalselection.net → Register → Fill the Paramedical application form → Upload documents → Pay the application fee online.' },
      { step: 2, title: 'Document Verification', description: 'Online verification of HSC marks, community, nativity. Same window as Pharmacy and Nursing.' },
      { step: 3, title: 'Merit Rank Calculation', description: 'NO entrance exam. Ranking is on HSC science subjects reduced to a base of 200. For BPT/MLT/most paramedical courses, PCB marks are used. For B.Optometry / B.ASLP, PCM marks are also accepted.' },
      { step: 4, title: 'Rank List Publication', description: 'Selection Committee publishes the provisional Paramedical degree rank list on tnmedicalselection.net.' },
      { step: 5, title: 'Online Choice Filling', description: 'Add colleges and courses (BPT, BMLT, B.Optom, etc.) in preference order. Read the seat matrix carefully — different courses have very different intakes.' },
      { step: 6, title: 'Seat Allotment', description: 'Single-window allotment based on rank + choice + community. Accept & report, or wait for the next round.' },
      { step: 7, title: 'Report to College', description: 'Carry original certificates and joining fee → Report within deadline to confirm admission.' },
    ],
    importantNotes: [
      'NO entrance exam — admission is purely merit-based on 12th science marks',
      'Wide range of careers: physiotherapist, lab technologist, radiographer, optometrist, audiologist, OT technician, etc.',
      'BPT is 4.5 years (with internship). Most other paramedical degrees are 3-4 years.',
      'Govt paramedical fees: ~₹10,000-25,000/year. Self-financing: ₹40,000-1 Lakh/year',
      'Strong placement potential in hospitals, diagnostic labs, rehab centres, and overseas',
      'Separate diploma-level counselling runs in parallel (Diploma in Pharmacy, Diploma in Optometry, etc.)',
    ],
    documentsRequired: [
      '12th HSC Mark Sheet',
      'Community Certificate (if applicable)',
