...
const counsellings: CounsellingInfo[] = [
  ...
  {
    id: 'tn-paramedical-degree',
    name: 'TN Paramedical Degree Courses',
    nameTamil: 'தமிழ்நாடு துணை மருத்துவ பட்டப் படிப்பு கலந்தாய்வு',
    icon: '🩺',
    color: 'text-teal-700',
    bg: 'bg-teal-50',
    border: 'border-teal-200',
    authority: 'Selection Committee, Directorate of Medical Education and Research (DMER), Tamil Nadu',
    forWhom: 'One unified counselling for ALL 19 paramedical degree courses, including B.Sc Nursing, B.Pharm, BPT, B.O.T, B.ASLP, B.Sc Radiography & Imaging Technology, B.Sc Radio Therapy, B.Sc Cardio-Pulmonary Perfusion, B.Sc Medical Lab Technology, B.Sc Operation Theatre & Anaesthesia Tech, B.Sc Cardiac Tech, B.Sc Critical Care, B.Sc Dialysis, B.Sc Physician Assistant, B.Sc Accident & Emergency Care, B.Sc Respiratory Therapy, B.Optom, B.Sc Neuro Electro Physiology, B.Sc Clinical Nutrition — in TN govt and self-financing colleges affiliated to Dr. M.G.R. Medical University.',
    eligibility: '12th Pass with the relevant science subjects (PCB for most; PCM accepted for B.Optom / B.ASLP). Min 50% in qualifying subjects (45% for SC/ST/MBC/BC). TN nativity. Age 17+ on 31 Dec of the admission year. Both genders eligible for B.Sc Nursing.',
    fee: '₹500 application fee (online). Separate counselling deposit collected at the time of allotment.',
    applyLink: 'https://reg25.tnmedicalonline.co.in/pmc25',
    officialSite: 'https://tnmedicalselection.net',
    tentativeDates: [
      { event: 'Online Application Opens', date: 'June-July 2026 (after HSC results)' },
      { event: 'Last Date to Apply', date: 'July-August 2026' },
      ...
      { event: 'Round 2 / Mop-up / Stray Vacancy', date: 'September-November 2026' },
    ],
    steps: [
      { step: 1, title: 'Single Application — All 19 Courses', description: 'IMPORTANT: TN Selection Committee runs ONE unified counselling for all paramedical degrees. A single application on tnmedicalselection.net (or the year-specific portal like reg25.tnmedicalonline.co.in) lets you compete for B.Sc Nursing, B.Pharm, BPT, BMLT, B.Optom and all 19 listed courses together. You do not file separate applications.' },
      { step: 2, title: 'Online Registration', description: 'Register with valid email and mobile → Fill personal, academic, community and nativity details → Pay the application fee online.' },
      { step: 3, title: 'Upload Documents', description: 'Upload scanned 12th marksheet, community certificate, nativity, Aadhar, transfer certificate, medical fitness certificate. Online verification — no in-person visit usually required.' },
      { step: 4, title: 'Merit Rank Calculation', description: 'NO entrance exam. Ranking is purely on 12th science marks reduced to a base of 200. For courses requiring Biology (Nursing, BPT, MLT, etc.) only PCB marks are counted. For B.Pharm both PCM and PCB are accepted. For B.Optom / B.ASLP, PCM marks can also be used.' },
      { step: 5, title: 'Provisional Rank List', description: 'DMER publishes the provisional rank list on tnmedicalselection.net — both overall and community-wise. Check carefully and report any discrepancy within the grievance window.' },
      { step: 6, title: 'Online Choice Filling (MOST IMPORTANT)', description: 'Login during your allotted slot → Browse the seat matrix → Add colleges AND courses in your preference order (e.g., MMC B.Sc Nursing → MMC B.Pharm → CMC Nursing → PSG B.Pharm → BPT etc.) → Lock choices using OTP. There is no limit on choices; add as many as possible.' },
      { step: 7, title: 'Single-Window Seat Allotment', description: 'Allotment runs on rank + choices + reservation roster. You can be allotted ANY of the 19 courses based on your preferences and rank. Options: Accept & report, Accept with upward movement (try for better in next round), or Decline.' },
      { step: 8, title: 'Report to College', description: 'Carry original documents and joining fee → Report to the allotted college within the deadline (usually 3-5 days). Hepatitis-B vaccination required before joining.' },
    ],
    importantNotes: [
      'ONE single counselling covers all 19 paramedical degrees including B.Sc Nursing and B.Pharm — you do NOT apply separately',
      'NO entrance exam — admission is purely merit-based on 12th science marks /200',
      'Reservation per TN policy: BC 26.5%, BC-Muslim 3.5%, MBC 20%, SC 15%, SC-A 3%, ST 1%, plus 7.5% Govt School Quota',
      'Govt college fees range ₹10,000-25,000/year depending on course. Self-financing: ₹40,000-1.5 Lakh/year',
      'B.Sc Nursing: both male and female candidates are eligible (court orders removed the earlier female-only restriction)',
      'B.Pharm = 4 years. BPT = 4.5 years (with internship). B.Sc Nursing = 4 years. Most others 3-4 years.',
      'Strong overseas potential for Nursing (NCLEX-RN for USA, HAAD/DHA for Gulf) and Pharmacy',
  ...
  {
    id: 'tn-pharm-d',
    name: 'TN Pharm.D Counselling (6-year & Post-Baccalaureate)',
    nameTamil: 'தமிழ்நாடு Pharm.D கலந்தாய்வு',
    icon: '💊',
    color: 'text-indigo-700',
    bg: 'bg-indigo-50',
    border: 'border-indigo-200',
    authority: 'Selection Committee, Directorate of Medical Education and Research (DMER), Tamil Nadu — separate from the unified Paramedical counselling',
    forWhom: 'Doctor of Pharmacy (Pharm.D) admission in TN self-financing pharmacy colleges affiliated to Dr. M.G.R. Medical University. Two streams: (a) Pharm.D 6 years — direct entry after 12th, (b) Pharm.D Post Baccalaureate 3 years — lateral entry for B.Pharm graduates.',
    eligibility: '6-year direct: 12th Pass with Physics, Chemistry, Biology/Mathematics. Min 50% in PCB/PCM (relaxation for reserved). Age 17+ on 31 Dec. Post Baccalaureate (3 yr): Pass in B.Pharm from a Pharmacy Council of India approved institution.',
    fee: '₹1,000 application fee (online). Plus separate counselling processing fee per round.',
    applyLink: 'https://tnmedicalselection.net',
    officialSite: 'https://tnmedicalselection.net',
    tentativeDates: [
      { event: 'Online Application Opens', date: 'May-June 2026' },
      { event: 'Last Date to Apply', date: 'June-July 2026' },
      { event: 'Provisional Rank List Release', date: 'July 2026' },
      { event: 'Online Counselling Round 1', date: 'July-August 2026' },
      { event: 'Round 2 / Stray Vacancy', date: 'August-September 2026' },
    ],
    steps: [
      { step: 1, title: 'Choose Your Stream', description: 'Decide between Pharm.D 6-year (direct after 12th) OR Pharm.D Post-Baccalaureate 3-year (for B.Pharm graduates only). The application forms are separate but both run via tnmedicalselection.net.' },
      { step: 2, title: 'Online Registration', description: 'Visit tnmedicalselection.net → Register and fill the relevant Pharm.D form → Upload documents → Pay the ₹1,000 application fee online.' },
      { step: 3, title: 'Document Verification', description: 'Online verification of HSC marks (for 6-year) or B.Pharm marksheet (for Post Baccalaureate), plus community, nativity, etc.' },
      { step: 4, title: 'Merit Rank Calculation', description: '6-year: ranking on 12th science marks (PCB or PCM) reduced to a base of 200. Post Baccalaureate: ranking on aggregate B.Pharm marks, normalised across universities.' },
      { step: 5, title: 'Rank List Publication', description: 'Selection Committee publishes the provisional rank list separately for the 6-year and 3-year courses.' },
      { step: 6, title: 'Online Choice Filling', description: 'Login during the counselling slot → Add Pharm.D colleges in preference order → Lock with OTP.' },
      { step: 7, title: 'Seat Allotment & Reporting', description: 'Single-window allotment based on rank + choices + reservation. Report to the allotted college with originals and joining fee within the deadline.' },
    ],
    importantNotes: [
      'Pharm.D is a SEPARATE counselling — distinct from the unified Paramedical Degree counselling (which includes B.Pharm)',
      'Only self-financing colleges offer Pharm.D in TN — no government Pharm.D seats',
      'Pharm.D = 6 years total (5 years academic + 1 year internship)',
      'Pharm.D Post Baccalaureate = 3 years; only for those already holding B.Pharm',
      'Pharm.D is a doctoral-level pharmacy qualification, distinct from B.Pharm. Recognised globally as the entry-level qualification for clinical pharmacy practice.',
      'Pharm.D fees: typically ₹80,000-1.5 Lakh/year in TN self-financing colleges',
      'Career options: clinical pharmacist, hospital pharmacy, pharmacovigilance, regulatory affairs (CDSCO/FDA), academia',
    ],
    documentsRequired: [
      '12th HSC Mark Sheet (for 6-year direct) OR B.Pharm Marksheets all years (for Post Baccalaureate)',
      'Pharmacy Council Registration Certificate (for Post Baccalaureate only)',
      'Community Certificate (if applicable)',
      'Nativity / Residence Certificate',
      'Income Certificate',
      'Aadhar Card',
      'Transfer Certificate / Provisional Certificate',
      'Medical Fitness Certificate',
      '4 passport-size photos',
    ],
  },
