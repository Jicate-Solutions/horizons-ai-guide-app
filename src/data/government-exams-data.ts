...
const stateExams: Exam[] = [
  {
    ...
    pyq: [
      ...
      { id: 'tnpsc-2024-gs2', question: 'The capital of Chola dynasty was:', questionTamil: 'சோழ வம்சத்தின் தலைநகரம்:', options: ['Madurai', 'Thanjavur', 'Kanchipuram', 'Trichy'], optionsTamil: ['மதுரை', 'தஞ்சாவூர்', 'காஞ்சிபுரம்', 'திருச்சி'], answer: 1, explanation: 'Thanjavur (Tanjore) was the capital of Chola dynasty under Rajaraja Chola I.', explanationTamil: 'தஞ்சாவூர் சோழ வம்சத்தின் தலைநகரமாக இருந்தது', subject: 'Tamil Nadu History', difficulty: 'easy' },
      ...
      { id: 'tnpsc-2024-apt2', question: 'The HCF of 12, 18, and 24 is:', questionTamil: '12, 18, 24 இன் மீப்பெரு பொது காரணி (HCF):', options: ['6', '12', '3', '2'], optionsTamil: ['6', '12', '3', '2'], answer: 0, explanation: '12 = 2²×3, 18 = 2×3², 24 = 2³×3. HCF = 2¹×3¹ = 6', explanationTamil: '12 = 2²×3, 18 = 2×3², 24 = 2³×3. HCF = 2×3 = 6', subject: 'Aptitude', difficulty: 'easy' },
      ...
      { id: 'tnpsc-2024-b19', question: 'First session of Indian National Congress was held at?', questionTamil: 'இந்திய தேசிய காங்கிரசின் முதல் கூட்டம் எங்கு நடைபெற்றது?', options: ['Calcutta', 'Madras', 'Bombay', 'Delhi'], optionsTamil: ['கல்கத்தா', 'மெட்ராஸ்', 'பம்பாய்', 'டெல்லி'], answer: 2, explanation: 'The first session of INC was held in Bombay (Mumbai) in December 1885 under W.C. Bonnerjee with 72 delegates.', explanationTamil: 'INC முதல் கூட்டம் 1885 டிசம்பரில் பம்பாயில் (மும்பை) W.C. பானர்ஜி தலைமையில் 72 பிரதிநிதிகளுடன் நடைபெற்றது', subject: 'History', difficulty: 'easy' },
      { id: 'tnpsc-2024-b20', question: 'Jai Hind slogan was given by?', questionTamil: 'ஜெய் ஹிந்த் முழக்கத்தை வழங்கியவர்?', options: ['Gandhi', 'Nehru', 'Subhash Chandra Bose', 'Tilak'], optionsTamil: ['காந்தி', 'நேரு', 'சுபாஷ் சந்திர போஸ்', 'திலகர்'], answer: 2, explanation: 'Subhash Chandra Bose (Netaji) gave the slogan "Jai Hind" (Victory to India) and also "Tum Mujhe Khoon Do, Main Tumhe Azadi Dunga".', explanationTamil: 'சுபாஷ் சந்திர போஸ் (நேதாஜி) "ஜெய் ஹிந்த்" முழக்கத்தை வழங்கினார். "எனக்கு இரத்தம் கொடுங்கள், சுதந்திரம் தருகிறேன்" என்றும் கூறினார்', subject: 'History', difficulty: 'easy' },
      { id: 'tnpsc-2024-m1', question: 'Complete the series: 2, 6, 12, 20, 30, ?', questionTamil: 'தொடரை நிரப்புக: 2, 6, 12, 20, 30, ?', options: ['40', '42', '44', '46'], optionsTamil: ['40', '42', '44', '46'], answer: 1, explanation: 'Differences: 4, 6, 8, 10, 12. Pattern: n(n+1). Next: 6×7 = 42.', explanationTamil: 'வேறுபாடுகள்: 4, 6, 8, 10, 12. முறை: n(n+1). அடுத்தது: 6×7 = 42', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-m2', question: 'HCF is 11, LCM is 693. One number is 77. Find the other.', questionTamil: 'மீ.பொ.கா 11, மீ.பொ.ம 693. ஒரு எண் 77 எனில் மற்றொன்று?', options: ['99', '66', '88', '110'], optionsTamil: ['99', '66', '88', '110'], answer: 0, explanation: 'Product of numbers = HCF × LCM. So 77 × x = 11 × 693 = 7623. x = 7623/77 = 99.', explanationTamil: 'எண்களின் பெருக்கல் = மீ.பொ.கா × மீ.பொ.ம. 77 × x = 11 × 693 = 7623. x = 7623/77 = 99', subject: 'Aptitude', difficulty: 'medium' },
      { id: 'tnpsc-2024-m3', question: 'Area of a circle with radius 7 cm?', questionTamil: '7 செ.மீ ஆரம் கொண்ட வட்டத்தின் பரப்பளவு?', options: ['44 cm²', '154 cm²', '308 cm²', '49 cm²'], optionsTamil: ['44 செ.மீ²', '154 செ.மீ²', '308 செ.மீ²', '49 செ.மீ²'], answer: 1, explanation: 'Area = πr² = (22/7) × 7 × 7 = 22 × 7 = 154 cm².', explanationTamil: 'பரப்பளவு = πr² = (22/7) × 7 × 7 = 22 × 7 = 154 செ.மீ²', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-p1', question: 'Dr. Ambedkar called which as the Heart and Soul of the Constitution?', questionTamil: 'அம்பேத்கர் அரசியலமைப்பின் இதயம் மற்றும் ஆன்மா என எதைக் குறிப்பிட்டார்?', options: ['Religious Freedom', 'Right to Property', 'Right to Constitutional Remedies (Art 32)', 'Right to Equality'], optionsTamil: ['சமய உரிமை', 'சொத்துரிமை', 'அரசியலமைப்பு தீர்வு உரிமை (விதி 32)', 'சமத்துவ உரிமை'], answer: 2, explanation: 'Dr. Ambedkar called Article 32 (Right to Constitutional Remedies) the "Heart and Soul" of the Constitution — it allows citizens to approach SC for enforcement of Fundamental Rights.', explanationTamil: 'டாக்டர் அம்பேத்கர் சரத்து 32-ஐ அரசியலமைப்பின் இதயம் மற்றும் ஆன்மா என்றார் — அடிப்படை உரிமைகளை நிலைநாட்ட உச்ச நீதிமன்றத்தை அணுகும் உரிமை', subject: 'Indian Polity', difficulty: 'medium' },
      { id: 'tnpsc-2024-p2', question: 'Which Amendment gave constitutional status to Panchayati Raj?', questionTamil: 'பஞ்சாயத்து ராஜ் அமைப்புக்கு அரசியலமைப்பு அந்தஸ்து வழங்கிய திருத்தம்?', options: ['42nd', '44th', '73rd', '74th'], optionsTamil: ['42வது', '44வது', '73வது', '74வது'], answer: 2, explanation: 'The 73rd Amendment Act (1992) gave constitutional status to Panchayati Raj institutions by adding Part IX to the Constitution.', explanationTamil: '73வது திருத்தச் சட்டம் (1992) பஞ்சாயத்து ராஜ் நிறுவனங்களுக்கு அரசியலமைப்பு அந்தஸ்து வழங்கியது — பகுதி IX சேர்க்கப்பட்டது', subject: 'Indian Polity', difficulty: 'medium' },
      ...
      { id: 'tnpsc-2024-p4', question: 'Justice Party was started in which year?', questionTamil: 'நீதிக்கட்சி தொடங்கப்பட்ட ஆண்டு?', options: ['1912', '1916', '1917', '1920'], optionsTamil: ['1912', '1916', '1917', '1920'], answer: 2, explanation: 'Justice Party (South Indian Liberal Federation) was founded in 1917 by T.M. Nair, P. Thyagaraja Chetty and C. Natesa Mudaliar.', explanationTamil: 'நீதிக்கட்சி 1917 இல் டி.எம். நாயர், பி. தியாகராஜ செட்டி, சி. நடேச முதலியார் ஆகியோரால் நிறுவப்பட்டது', subject: 'Tamil Nadu History', difficulty: 'medium' },
      { id: 'tnpsc-2024-p5', question: 'Where are Red Blood Cells (RBCs) produced in the human body?', questionTamil: 'இரத்தச் சிவப்பணுக்கள் எங்கு உருவாகின்றன?', options: ['Liver', 'Spleen', 'Bone Marrow', 'Heart'], optionsTamil: ['கல்லீரல்', 'மண்ணீரல்', 'எலும்பு மஜ்ஜை', 'இதயம்'], answer: 2, explanation: 'Red Blood Cells are produced in the Bone Marrow (erythropoiesis). RBCs carry oxygen using hemoglobin.', explanationTamil: 'இரத்தச் சிவப்பணுக்கள் எலும்பு மஜ்ஜையில் உருவாகின்றன. ஹீமோகுளோபின் மூலம் ஆக்சிஜனை எடுத்துச் செல்கின்றன', subject: 'General Science', difficulty: 'easy' },
      { id: 'tnpsc-2024-p6', question: 'Selling price of an item bought at ₹150 with 20% profit?', questionTamil: '₹150-க்கு வாங்கி 20% இலாபத்தில் விற்ற விலை?', options: ['₹170', '₹180', '₹190', '₹200'], optionsTamil: ['₹170', '₹180', '₹190', '₹200'], answer: 1, explanation: 'SP = CP × (1 + Profit%) = 150 × 1.20 = ₹180.', explanationTamil: 'விற்பனை விலை = வாங்கிய விலை × (1 + இலாப%) = 150 × 1.20 = ₹180', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-p7', question: 'If 2^x = 64, what is x?', questionTamil: '2^x = 64 எனில் x-ன் மதிப்பு?', options: ['4', '5', '6', '8'], optionsTamil: ['4', '5', '6', '8'], answer: 2, explanation: '2^6 = 64. So x = 6. (2¹=2, 2²=4, 2³=8, 2⁴=16, 2⁵=32, 2⁶=64)', explanationTamil: '2^6 = 64. எனவே x = 6. (2¹=2, 2²=4, 2³=8, 2⁴=16, 2⁵=32, 2⁶=64)', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-p8', question: 'Triangle angles ratio 2:3:5, largest angle?', questionTamil: 'முக்கோண கோணங்கள் 2:3:5 விகிதம், பெரிய கோணம்?', options: ['60°', '90°', '100°', '120°'], optionsTamil: ['60°', '90°', '100°', '120°'], answer: 1, explanation: 'Sum = 180°. Parts = 2+3+5 = 10. Largest = (5/10)×180 = 90°. It is a right triangle.', explanationTamil: 'கூட்டுத்தொகை = 180°. பாகங்கள் = 10. பெரிய கோணம் = (5/10)×180 = 90°. செங்கோண முக்கோணம்', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-p9', question: 'Square side increases 10%, area increases by?', questionTamil: 'சதுரத்தின் பக்கம் 10% அதிகரித்தால் பரப்பளவு அதிகரிப்பு?', options: ['10%', '20%', '21%', '100%'], optionsTamil: ['10%', '20%', '21%', '100%'], answer: 2, explanation: 'New area = (1.1)² = 1.21 times original. Increase = 21%. Formula: 2a + a²/100 where a=10: 20+1=21%.', explanationTamil: 'புதிய பரப்பு = (1.1)² = 1.21 மடங்கு. அதிகரிப்பு = 21%', subject: 'Aptitude', difficulty: 'medium' },
      { id: 'tnpsc-2024-p10', question: 'Simplify: (1000)⁰ + (50)⁰ + (1)⁰', questionTamil: 'சுருக்குக: (1000)⁰ + (50)⁰ + (1)⁰', options: ['1051', '3', '0', '1'], optionsTamil: ['1051', '3', '0', '1'], answer: 1, explanation: 'Any number raised to power 0 equals 1. So 1 + 1 + 1 = 3.', explanationTamil: 'எந்த எண்ணும் 0 ஆம் அடுக்கு = 1. எனவே 1 + 1 + 1 = 3', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-p11', question: 'Members nominated to Rajya Sabha by the President?', questionTamil: 'குடியரசுத் தலைவர் ராஜ்யசபாவுக்கு நியமிக்கும் உறுப்பினர்கள்?', options: ['2', '10', '12', '15'], optionsTamil: ['2', '10', '12', '15'], answer: 2, explanation: 'The President nominates 12 members to Rajya Sabha from fields of literature, science, art, and social service (Article 80).', explanationTamil: 'குடியரசுத் தலைவர் இலக்கியம், அறிவியல், கலை, சமூக சேவை துறைகளில் 12 உறுப்பினர்களை ராஜ்யசபாவுக்கு நியமிக்கிறார் (சரத்து 80)', subject: 'Indian Polity', difficulty: 'easy' },
      ...
      { id: 'tnpsc-2024-q161', question: 'If the radius of a sphere is increased by 25%, by what percent does the surface area increase?', questionTamil: 'ஒரு கோளத்தின் ஆரம் 25% அதிகரித்தால் புறப்பரப்பு எத்தனை % அதிகரிக்கும்?', options: ['25%', '50%', '56.25%', '62.25%'], optionsTamil: ['25%', '50%', '56.25%', '62.25%'], answer: 2, explanation: 'Surface area ∝ r². New SA = (1.25)² = 1.5625 times. Increase = 56.25%.', explanationTamil: 'புறப்பரப்பு ∝ r². புதிய SA = (1.25)² = 1.5625 மடங்கு. அதிகரிப்பு = 56.25%', subject: 'Aptitude', difficulty: 'hard' },
      { id: 'tnpsc-2024-q162', question: '1 + 2 + 3 + ... + n = 666. Find n.', questionTamil: '1 + 2 + 3 + ... + n = 666 எனில் n-ன் மதிப்பு?', options: ['35', '36', '37', '38'], optionsTamil: ['35', '36', '37', '38'], answer: 1, explanation: 'n(n+1)/2 = 666. n(n+1) = 1332. n = 36 (36×37 = 1332).', explanationTamil: 'n(n+1)/2 = 666. n(n+1) = 1332. n = 36 (36×37 = 1332)', subject: 'Aptitude', difficulty: 'medium' },
      { id: 'tnpsc-2024-q163', question: 'Triangle sides ratio 3:4:5, perimeter 144 cm. Find area.', questionTamil: 'முக்கோண பக்கங்கள் 3:4:5, சுற்றளவு 144 செ.மீ. பரப்பளவு?', options: ['864 cm²', '432 cm²', '124 cm²', '648 cm²'], optionsTamil: ['864 ச.செ.மீ', '432 ச.செ.மீ', '124 ச.செ.மீ', '648 ச.செ.மீ'], answer: 0, explanation: 'Sides = 36, 48, 60 cm (×12). Right triangle (3:4:5). Area = ½×36×48 = 864 cm².', explanationTamil: 'பக்கங்கள் = 36, 48, 60 செ.மீ. செங்கோண முக்கோணம். பரப்பு = ½×36×48 = 864 ச.செ.மீ', subject: 'Aptitude', difficulty: 'medium' },
      { id: 'tnpsc-2024-q164', question: 'Simplify: √(12 + √(12 + √(12 + ...)))', questionTamil: 'சுருக்குக: √(12 + √(12 + √(12 + ...)))', options: ['3', '4', '6', '12'], optionsTamil: ['3', '4', '6', '12'], answer: 1, explanation: 'Let x = √(12+x). x² = 12+x. x²-x-12 = 0. (x-4)(x+3) = 0. x = 4.', explanationTamil: 'x = √(12+x) என்க. x² = 12+x. x²-x-12 = 0. (x-4)(x+3) = 0. x = 4', subject: 'Aptitude', difficulty: 'hard' },
      { id: 'tnpsc-2024-q165', question: 'Probability of getting a prime number when rolling a die?', questionTamil: 'பகடை உருட்டும்போது பகா எண் கிடைக்கும் நிகழ்தகவு?', options: ['1/2', '1/3', '1/6', '2/3'], optionsTamil: ['1/2', '1/3', '1/6', '2/3'], answer: 0, explanation: 'Prime numbers on a die: 2, 3, 5 (3 numbers out of 6). P = 3/6 = 1/2.', explanationTamil: 'பகடையில் பகா எண்கள்: 2, 3, 5 (6 இல் 3). நிகழ்தகவு = 3/6 = 1/2', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-q167', question: 'Find LCM of 15, 25, 40, 75:', questionTamil: '15, 25, 40, 75 இன் மீ.பொ.ம?', options: ['300', '600', '1200', '1500'], optionsTamil: ['300', '600', '1200', '1500'], answer: 1, explanation: '15=3×5, 25=5², 40=2³×5, 75=3×5². LCM = 2³×3×5² = 8×3×25 = 600.', explanationTamil: '15=3×5, 25=5², 40=2³×5, 75=3×5². மீ.பொ.ம = 2³×3×5² = 600', subject: 'Aptitude', difficulty: 'medium' },
      { id: 'tnpsc-2024-q169', question: 'Parallelogram: base 12 cm, height 8 cm. Area?', questionTamil: 'இணைகரம்: அடி 12 செ.மீ, உயரம் 8 செ.மீ. பரப்பளவு?', options: ['40 cm²', '80 cm²', '96 cm²', '48 cm²'], optionsTamil: ['40 ச.செ.மீ', '80 ச.செ.மீ', '96 ச.செ.மீ', '48 ச.செ.மீ'], answer: 2, explanation: 'Area of parallelogram = base × height = 12 × 8 = 96 cm².', explanationTamil: 'இணைகரத்தின் பரப்பு = அடி × உயரம் = 12 × 8 = 96 ச.செ.மீ', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-q186', question: 'Cuboid: length 10, width 8, height 5 cm. Volume?', questionTamil: 'கனசெவ்வகம்: நீளம் 10, அகலம் 8, உயரம் 5 செ.மீ. கனஅளவு?', options: ['400 cm³', '200 cm³', '800 cm³', '160 cm³'], optionsTamil: ['400 க.செ.மீ', '200 க.செ.மீ', '800 க.செ.மீ', '160 க.செ.மீ'], answer: 0, explanation: 'Volume = l × b × h = 10 × 8 × 5 = 400 cm³.', explanationTamil: 'கனஅளவு = நீளம் × அகலம் × உயரம் = 10 × 8 × 5 = 400 க.செ.மீ', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-q190', question: 'Triangle: base 10 cm, height 12 cm. Area?', questionTamil: 'முக்கோணம்: அடி 10 செ.மீ, உயரம் 12 செ.மீ. பரப்பளவு?', options: ['120 cm²', '60 cm²', '30 cm²', '240 cm²'], optionsTamil: ['120 ச.செ.மீ', '60 ச.செ.மீ', '30 ச.செ.மீ', '240 ச.செ.மீ'], answer: 1, explanation: 'Area of triangle = ½ × base × height = ½ × 10 × 12 = 60 cm².', explanationTamil: 'முக்கோண பரப்பு = ½ × அடி × உயரம் = ½ × 10 × 12 = 60 ச.செ.மீ', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-q196', question: 'A man covers 10 km in 2 hours. His speed?', questionTamil: 'ஒரு மனிதன் 10 கி.மீ தூரத்தை 2 மணியில் கடந்தால் வேகம்?', options: ['5 km/hr', '20 km/hr', '12 km/hr', '8 km/hr'], optionsTamil: ['5 கி.மீ/மணி', '20 கி.மீ/மணி', '12 கி.மீ/மணி', '8 கி.மீ/மணி'], answer: 0, explanation: 'Speed = Distance/Time = 10/2 = 5 km/hr.', explanationTamil: 'வேகம் = தூரம்/நேரம் = 10/2 = 5 கி.மீ/மணி', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-q197', question: 'Manchester of India?', questionTamil: 'இந்தியாவின் மான்செஸ்டர்?', options: ['Mumbai', 'Ahmedabad', 'Coimbatore', 'Kanpur'], optionsTamil: ['மும்பை', 'அகமதாபாத்', 'கோயம்புத்தூர்', 'கான்பூர்'], answer: 1, explanation: 'Ahmedabad is called Manchester of India (cotton textile industry). Coimbatore = Manchester of South India.', explanationTamil: 'அகமதாபாத் இந்தியாவின் மான்செஸ்டர் (பருத்தி ஜவுளி). கோயம்புத்தூர் = தென்னிந்தியாவின் மான்செஸ்டர்', subject: 'Geography', difficulty: 'easy' },
      { id: 'tnpsc-2024-q198', question: 'Largest chord in a circle?', questionTamil: 'வட்டத்தில் மிகப்பெரிய நாண்?', options: ['Radius', 'Diameter', 'Arc', 'Tangent'], optionsTamil: ['ஆரம்', 'விட்டம்', 'வில்', 'தொடுகோடு'], answer: 1, explanation: 'The diameter is the largest chord of a circle. It passes through the center and equals 2 × radius.', explanationTamil: 'விட்டம் வட்டத்தின் மிகப்பெரிய நாண். மையம் வழியாகச் செல்கிறது, 2 × ஆரம் = விட்டம்', subject: 'Aptitude', difficulty: 'easy' },
      { id: 'tnpsc-2024-q200', question: '20% of a number is 60. Find the number.', questionTamil: 'ஒரு எண்ணின் 20% = 60 எனில் அந்த எண்?', options: ['200', '300', '400', '500'], optionsTamil: ['200', '300', '400', '500'], answer: 1, explanation: '20% of x = 60. x = 60 × 100/20 = 300.', explanationTamil: 'x இன் 20% = 60. x = 60 × 100/20 = 300', subject: 'Aptitude', difficulty: 'easy' },
      ...
      { id: 'tnpsc-2019-b6', question: 'First Battle of Panipat year?', questionTamil: 'முதல் பாணிப்பட் போர் ஆண்டு?', options: ['1526', '1556', '1761', '1576'], optionsTamil: ['1526', '1556', '1761', '1576'], answer: 0, explanation: 'First Battle of Panipat (1526): Babur vs Ibrahim Lodi. Second (1556): Akbar vs Hemu. Third (1761): Ahmad Shah Abdali vs Marathas.', explanationTamil: 'முதல் பாணிப்பட் (1526): பாபர் vs இப்ராகிம் லோடி. இரண்டாம் (1556): அக்பர். மூன்றாம் (1761): மராட்டியர்', subject: 'History', difficulty: 'easy' },
      { id: 'tnpsc-2019-b7', question: 'Father of Computer?', questionTamil: 'கணினியின் தந்தை?', options: ['Charles Babbage', 'Archimedes', 'Edison', 'Newton'], optionsTamil: ['சார்லஸ் பாபேஜ்', 'ஆர்க்கிமிடிஸ்', 'எடிசன்', 'நியூட்டன்'], answer: 0, explanation: 'Charles Babbage is the Father of Computer. He invented the Difference Engine and Analytical Engine in the 1830s.', explanationTamil: 'சார்லஸ் பாபேஜ் கணினியின் தந்தை. 1830 களில் டிஃபரன்ஸ் எஞ்சின் மற்றும் அனலிட்டிகல் எஞ்சினை கண்டுபிடித்தார்', subject: 'General Science', difficulty: 'easy' },
      { id: 'tnpsc-2019-b8', question: 'Laughing gas is?', questionTamil: 'சிரிப்பூட்டும் வாயு?', options: ['Nitric oxide', 'Nitrous oxide', 'Nitrogen dioxide', 'Carbon monoxide'], optionsTamil: ['நைட்ரிக் ஆக்சைடு', 'நைட்ரஸ் ஆக்சைடு', 'நைட்ரஜன் டை ஆக்சைடு', 'கார்பன் மோனாக்சைடு'], answer: 1, explanation: 'Nitrous oxide (N₂O) is called Laughing Gas. Used as anaesthetic in dentistry. Discovered by Joseph Priestley.', explanationTamil: 'நைட்ரஸ் ஆக்சைடு (N₂O) சிரிப்பூட்டும் வாயு. பல் மருத்துவத்தில் மயக்க மருந்தாக பயன்படுகிறது', subject: 'General Science', difficulty: 'easy' },
      { id: 'tnpsc-2019-b9', question: '1 Horse Power = ? Watts', questionTamil: '1 குதிரைத்திறன் = ? வாட்', options: ['746 W', '750 W', '1000 W', '500 W'], optionsTamil: ['746 வாட்', '750 வாட்', '1000 வாட்', '500 வாட்'], answer: 0, explanation: '1 HP (Horse Power) = 746 Watts. Named after James Watt who improved the steam engine.', explanationTamil: '1 HP (குதிரைத்திறன்) = 746 வாட். ஜேம்ஸ் வாட் பெயரால் அழைக்கப்படுகிறது', subject: 'General Science', difficulty: 'medium' },
      ...
      { id: 'tnpsc-2019-g1', question: 'Granary of Indus Valley was found at?', questionTamil: 'சிந்து சமவெளி தானியக் களஞ்சியம் எங்கு?', options: ['Lothal', 'Harappa', 'Mohenjo-daro', 'Kalibangan'], optionsTamil: ['லோத்தல்', 'ஹரப்பா', 'மொகஞ்சதாரோ', 'காலிபங்கன்'], answer: 1, explanation: 'The Great Granary was found at Harappa. Great Bath at Mohenjo-daro. Dockyard at Lothal.', explanationTamil: 'தானியக் களஞ்சியம் ஹரப்பாவில். பெருங்குளம் மொகஞ்சதாரோவில். கப்பல் கட்டுமானத்தளம் லோத்தலில்', subject: 'History', difficulty: 'medium' },
      ...
      { id: 'tnpsc-2019-g12', question: 'White Revolution is associated with?', questionTamil: 'வெண்மைப் புரட்சி எதனுடன் தொடர்புடையது?', options: ['Fish', 'Eggs', 'Milk', 'Wheat'], optionsTamil: ['மீன்', 'முட்டை', 'பால்', 'கோதுமை'], answer: 2, explanation: 'White Revolution (Operation Flood) = Milk production. Led by Dr. Verghese Kurien (Amul). Green = Food grains. Blue = Fish.', explanationTamil: 'வெண்மைப் புரட்சி = பால் உற்பத்தி. டாக்டர் வர்கீஸ் குரியன் (அமுல்) தலைமையில். பசுமை = உணவு தானியம். நீலம் = மீன்', subject: 'General Knowledge', difficulty: 'easy' },
      { id: 'tnpsc-2019-g13', question: 'Total bones in human body?', questionTamil: 'மனித உடலில் எலும்புகளின் எண்ணிக்கை?', options: ['200', '206', '210', '215'], optionsTamil: ['200', '206', '210', '215'], answer: 1, explanation: 'Adult human body has 206 bones. At birth = ~270 bones (some fuse together as we grow).', explanationTamil: 'வயது வந்த மனித உடலில் 206 எலும்புகள். பிறக்கும்போது ~270 (வளரும்போது சில இணைகின்றன)', subject: 'General Science', difficulty: 'easy' },
