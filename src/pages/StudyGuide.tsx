...
const neetGuide: ExamStudyGuide = {
  ...
  subjects: [
    ...
    },
    {
      ...
      topics: [
        // PHYSICAL CHEMISTRY
        { id: 'nc-mole', name: 'Some Basic Concepts (Mole Concept)', ncertChapter: 'Class 11 Ch.1', keyConcepts: ['Mole = 6.022 × 10²³ particles (Avogadro number)', 'Moles = mass/Molar mass = molecules/Nₐ = volume/22.4L at STP', 'Empirical formula vs Molecular formula', 'Limiting reagent — determines how much product forms', 'Percentage composition, stoichiometry of reactions', 'Molarity (M) = moles/L, Molality (m) = moles/kg solvent'], importantFormulas: ['n = mass/M = N/Nₐ = V/22.4(STP)', 'M = n/V(L)', 'm = n/W(kg)'], recommendedBooks: ['NCERT Ch.1', 'OP Tandon Physical Chemistry'], tips: 'Mole concept = foundation of all Chemistry. If this is weak, everything fails. Solve 50+ numerical problems.', weightage: '2-3 questions', difficulty: 'easy' },
        { id: 'nc-atom', name: 'Structure of Atom', ncertChapter: 'Class 11 Ch.2', keyConcepts: ['Bohr model: rₙ = 0.529n²/Z Å, Eₙ = -13.6Z²/n² eV', 'Quantum numbers: n (principal), l (azimuthal), ml (magnetic), ms (spin)', 'Aufbau principle, Pauli exclusion, Hund\'s rule', 'Electronic configuration writing rules', 'Shapes of orbitals: s(sphere), p(dumbbell), d(cloverleaf)', 'de Broglie: λ = h/mv, Heisenberg uncertainty: Δx·Δp ≥ h/4π'], importantFormulas: ['Eₙ = -13.6Z²/n² eV', 'λ = h/mv', 'Δx·Δp ≥ h/4π'], recommendedBooks: ['NCERT Ch.2', 'OP Tandon'], tips: 'Learn electron configurations for all elements up to Z=30. Exceptions: Cr (3d⁵4s¹) and Cu (3d¹⁰4s¹).', weightage: '2-3 questions', difficulty: 'medium' },
        { id: 'nc-states', name: 'States of Matter (Gases)', ncertChapter: 'Class 11 Ch.5', keyConcepts: ['Ideal gas equation: PV = nRT', 'Gas laws: Boyle, Charles, Gay-Lussac, Avogadro', 'Kinetic molecular theory: KE = 3/2 kT', 'Real gases: Van der Waals equation (P + a/V²)(V - b) = nRT', 'Critical temperature, Boyle temperature', 'Graham\'s law of diffusion: r ∝ 1/√M'], importantFormulas: ['PV = nRT', 'KE = 3/2 kT', 'r₁/r₂ = √(M₂/M₁)'], recommendedBooks: ['NCERT Ch.5', 'OP Tandon'], tips: 'Most problems are plug-and-play with PV=nRT. Master unit conversions (atm↔Pa, L↔m³).', weightage: '1-2 questions', difficulty: 'easy' },
        { id: 'nc-thermo', name: 'Thermodynamics', ncertChapter: 'Class 11 Ch.6', keyConcepts: ['First law: ΔU = q + w, w = -PΔV (expansion work)', 'Enthalpy: H = U + PV, ΔH = qₚ (at constant pressure)', 'Hess\'s law: ΔH is path-independent', 'Standard enthalpies: formation, combustion, atomization', 'Entropy (S): measure of disorder, ΔS_universe > 0 (spontaneous)', 'Gibbs free energy: ΔG = ΔH - TΔS, ΔG < 0 = spontaneous'], importantFormulas: ['ΔU = q + w', 'ΔG = ΔH - TΔS', 'ΔG° = -RTlnK'], recommendedBooks: ['NCERT Ch.6', 'OP Tandon', 'N Avasthi'], tips: 'Thermodynamics is conceptual + numerical. Understand sign conventions carefully. ΔG decides spontaneity, not ΔH alone.', weightage: '2-3 questions', difficulty: 'medium' },
        { id: 'nc-equil', name: 'Equilibrium', ncertChapter: 'Class 11 Ch.7', keyConcepts: ['Law of mass action: Kc = [products]/[reactants]', 'Kp = Kc(RT)^Δn', 'Le Chatelier\'s principle: system opposes change', 'Acids & Bases: Arrhenius, Brønsted-Lowry, Lewis definitions', 'pH = -log[H⁺], pOH = -log[OH⁻], pH + pOH = 14', 'Buffer solutions: Henderson-Hasselbalch equation', 'Common ion effect, Solubility product (Ksp)'], importantFormulas: ['pH = -log[H⁺]', 'Kw = [H⁺][OH⁻] = 10⁻¹⁴', 'pH = pKa + log([A⁻]/[HA])'], recommendedBooks: ['NCERT Ch.7', 'OP Tandon', 'N Avasthi'], tips: 'pH problems come EVERY year (2-3 questions). Practice all types: strong acid, weak acid, buffer, hydrolysis.', weightage: '3-4 questions', difficulty: 'medium' },
        { id: 'nc-redox', name: 'Redox Reactions', ncertChapter: 'Class 11 Ch.8', keyConcepts: ['Oxidation = loss of electrons, Reduction = gain of electrons', 'Oxidation number rules and calculation', 'Types: Combination, Decomposition, Displacement, Disproportionation', 'Balancing redox: Half-reaction method, Oxidation number method', 'Electrochemical series: higher = stronger reducing agent'], recommendedBooks: ['NCERT Ch.8'], tips: 'Learn oxidation number rules by heart. Practice balancing 10+ redox equations.', weightage: '1 question', difficulty: 'easy' },
        { id: 'nc-solutions', name: 'Solutions', ncertChapter: 'Class 12 Ch.2', keyConcepts: ['Concentration terms: Molarity, Molality, Mole fraction, ppm', 'Raoult\'s law: P = P°·x (for ideal solutions)', 'Colligative properties: ΔTb, ΔTf, π (osmotic pressure)', 'ΔTb = Kb·m, ΔTf = Kf·m, π = iCRT', 'Van\'t Hoff factor (i) for electrolytes', 'Abnormal molar mass: association vs dissociation'], importantFormulas: ['ΔTb = iKb·m', 'ΔTf = iKf·m', 'π = iCRT', 'M₂ = w₂RT/(πV)'], recommendedBooks: ['NCERT Ch.2', 'OP Tandon'], tips: 'Numericals on colligative properties are guaranteed. Practice ΔTb, ΔTf, osmotic pressure calculations.', weightage: '2-3 questions', difficulty: 'medium' },
        { id: 'nc-electro', name: 'Electrochemistry', ncertChapter: 'Class 12 Ch.3', keyConcepts: ['Galvanic cell: spontaneous, produces electricity (Daniell cell)', 'Electrolytic cell: non-spontaneous, needs external voltage', 'E°cell = E°cathode - E°anode', 'Nernst equation: E = E° - (RT/nF)lnQ', 'Faraday\'s laws: m = ZIt, m = (M × I × t)/(n × F)', 'Conductivity: specific (κ), molar (Λm), Kohlrausch\'s law'], importantFormulas: ['E = E° - (0.0591/n)logQ (at 25°C)', 'ΔG° = -nFE°', 'm = MIt/nF', 'Λm = κ × 1000/M'], recommendedBooks: ['NCERT Ch.3', 'OP Tandon', 'N Avasthi'], tips: 'Nernst equation numericals come every year. Remember: 0.0591/n at 25°C. Practice cell notation (anode || cathode).', weightage: '2-3 questions', difficulty: 'hard' },
        { id: 'nc-kinetics', name: 'Chemical Kinetics', ncertChapter: 'Class 12 Ch.4', keyConcepts: ['Rate = -d[R]/dt = d[P]/dt', 'Rate law: Rate = k[A]ⁿ (n = order, found experimentally)', 'Zero order: [A] = [A₀] - kt, t½ = [A₀]/2k', 'First order: ln[A] = ln[A₀] - kt, t½ = 0.693/k', 'Arrhenius equation: k = Ae^(-Ea/RT)', 'Activation energy: minimum energy for reaction to occur'], importantFormulas: ['t½ = 0.693/k (1st order)', 'k = Ae^(-Ea/RT)', 'log(k₂/k₁) = Ea/2.303R × (1/T₁ - 1/T₂)'], recommendedBooks: ['NCERT Ch.4', 'OP Tandon'], tips: 'First order kinetics = most tested. Learn t½ = 0.693/k and the integrated rate law. Practice Arrhenius problems.', weightage: '2-3 questions', difficulty: 'medium' },
        { id: 'nc-surface', name: 'Surface Chemistry', ncertChapter: 'Class 12 Ch.5', keyConcepts: ['Adsorption: Physical (van der Waals) vs Chemical (chemisorption)', 'Freundlich isotherm: x/m = kP^(1/n)', 'Colloids: Types (sol, gel, emulsion), Tyndall effect', 'Coagulation: Hardy-Schulze rule (higher charge = better coagulant)', 'Emulsions: oil-in-water vs water-in-oil', 'Catalysis: Homogeneous vs Heterogeneous, Enzyme catalysis'], recommendedBooks: ['NCERT Ch.5'], tips: 'Mostly theory-based. Read NCERT carefully. Focus on colloid properties and Hardy-Schulze rule.', weightage: '1-2 questions', difficulty: 'easy' },
        // ORGANIC CHEMISTRY — chapter-wise
        { id: 'nc-goc', name: 'General Organic Chemistry (GOC)', ncertChapter: 'Class 11 Ch.12', keyConcepts: ['Hybridization: sp³ (tetrahedral), sp² (trigonal), sp (linear)', 'Inductive effect: +I (electron donating) vs -I (electron withdrawing)', 'Resonance: delocalization of electrons, stability rules', 'Hyperconjugation: σ-bond electrons delocalize into p-orbital', 'Electromeric effect: temporary shift under attacking reagent', 'Carbocation stability: 3° > 2° > 1° > CH₃⁺', 'Isomerism: Chain, Position, Functional, Metamerism, Tautomerism'], recommendedBooks: ['NCERT Ch.12', 'MS Chouhan Organic', 'Morrison & Boyd Ch.1-4'], tips: 'GOC is the FOUNDATION of organic chemistry. If you understand electron effects, every reaction makes sense. Don\'t memorize — understand WHY.', weightage: '2-3 questions', difficulty: 'medium' },
        { id: 'nc-hydrocarbons', name: 'Hydrocarbons', ncertChapter: 'Class 11 Ch.13', keyConcepts: ['Alkanes: sp³, free radical substitution (halogenation)', 'Alkenes: sp², electrophilic addition (Markovnikov/Anti-Markovnikov)', 'Alkynes: sp, acidic hydrogen, addition reactions', 'Aromatic: Benzene, electrophilic substitution (Friedel-Crafts)', 'IUPAC naming rules for all hydrocarbons', 'Conformations of ethane (Newman projections)'], recommendedBooks: ['NCERT Ch.13', 'MS Chouhan'], tips: 'Learn Markovnikov rule, anti-Markovnikov (peroxide effect), and Friedel-Crafts reactions thoroughly.', weightage: '2 questions', difficulty: 'medium' },
        { id: 'nc-haloalkanes', name: 'Haloalkanes & Haloarenes', ncertChapter: 'Class 12 Ch.10', keyConcepts: ['SN1: 2-step, carbocation, racemization, 3° substrate preferred', 'SN2: 1-step, backside attack, Walden inversion, 1° substrate preferred', 'E1 vs E2 elimination: Saytzeff rule (more substituted alkene)', 'Grignard reagent: RMgX — used for C-C bond formation', 'Wurtz reaction: 2RX + 2Na → R-R', 'Fittig and Wurtz-Fittig reactions for aryl halides'], recommendedBooks: ['NCERT Ch.10', 'MS Chouhan', 'Himanshu Pandey'], tips: 'SN1 vs SN2 comparison is the most asked topic in Organic. Make a comparison table with all 5 differences.', weightage: '2-3 questions', difficulty: 'hard' },
        { id: 'nc-alcohols', name: 'Alcohols, Phenols & Ethers', ncertChapter: 'Class 12 Ch.11', keyConcepts: ['Alcohol classification: 1°, 2°, 3° based on C attached to OH', 'Lucas test: 3° (immediate turbid), 2° (5 min), 1° (no reaction)', 'Dehydration: Alcohol → Alkene (conc. H₂SO₄, 170°C)', 'Phenol: acidic (more than alcohol), Kolbe reaction, Reimer-Tiemann', 'Williamson synthesis: RONa + RX → R-O-R (ether)', 'Victor Meyer test to distinguish 1°, 2°, 3° alcohols'], recommendedBooks: ['NCERT Ch.11', 'MS Chouhan'], tips: 'Know ALL distinction tests: Lucas, Victor Meyer, Iodoform. These are direct exam questions.', weightage: '2-3 questions', difficulty: 'medium' },
        { id: 'nc-carbonyl', name: 'Aldehydes, Ketones & Carboxylic Acids', ncertChapter: 'Class 12 Ch.12', keyConcepts: ['Nucleophilic addition: Aldehyde/Ketone + HCN, NaHSO₃, Grignard', 'Aldol condensation: 2 molecules with α-H → β-hydroxy aldehyde', 'Cannizzaro reaction: aldehyde without α-H → acid + alcohol', 'Tollen\'s test (silver mirror): positive for aldehydes only', 'Fehling\'s test (red ppt): positive for aldehydes only', 'Carboxylic acid reactions: esterification, Hell-Volhard-Zelinsky', 'Acidity order: Carboxylic acid > Phenol > Alcohol > Water'], recommendedBooks: ['NCERT Ch.12', 'MS Chouhan', 'Morrison & Boyd'], tips: 'Name reactions from this chapter are MOST asked: Aldol, Cannizzaro, Clemmensen, Wolff-Kishner, Rosenmund. Learn all with mechanisms.', weightage: '3-4 questions', difficulty: 'hard' },
        { id: 'nc-amines', name: 'Amines', ncertChapter: 'Class 12 Ch.13', keyConcepts: ['Classification: 1° (R-NH₂), 2° (R₂NH), 3° (R₃N)', 'Basicity: Aliphatic amines > NH₃ > Aromatic amines', 'Hinsberg test: distinguish 1°, 2°, 3° amines', 'Carbylamine reaction: 1° amine + CHCl₃ + KOH → isocyanide (foul smell)', 'Diazotization: ArNH₂ + HNO₂ → ArN₂⁺Cl⁻ (diazonium salt)', 'Sandmeyer reaction, Gattermann reaction from diazonium salt'], recommendedBooks: ['NCERT Ch.13', 'MS Chouhan'], tips: 'Basicity order and distinction tests (Hinsberg, Carbylamine) are frequently asked. Diazonium reactions = easy marks.', weightage: '2 questions', difficulty: 'medium' },
        { id: 'nc-biomolecules', name: 'Biomolecules', ncertChapter: 'Class 12 Ch.14', keyConcepts: ['Carbohydrates: Monosaccharides (glucose, fructose), Disaccharides (sucrose, lactose, maltose)', 'Glucose: Open chain (aldohexose) and Haworth structures', 'Amino acids: 20 essential, Zwitter ion form, Isoelectric point', 'Proteins: Primary (sequence), Secondary (α-helix, β-sheet), Tertiary, Quaternary structure', 'Enzymes: biological catalysts, lock and key model', 'DNA vs RNA: differences in sugar, base, strand', 'Vitamins: Water soluble (B, C) vs Fat soluble (A, D, E, K)'], recommendedBooks: ['NCERT Ch.14'], tips: 'Pure NCERT — every line matters. Know glucose structure (open chain + Haworth), amino acid structure, DNA vs RNA differences.', weightage: '2-3 questions', difficulty: 'easy' },
        { id: 'nc-polymers', name: 'Polymers & Chemistry in Everyday Life', ncertChapter: 'Class 12 Ch.15-16', keyConcepts: ['Addition polymers: Polythene, PVC, Teflon, Polystyrene', 'Condensation polymers: Nylon 6,6, Bakelite, Dacron', 'Natural polymers: Rubber, Starch, Cellulose, Proteins', 'Drugs: Analgesics (aspirin), Antibiotics (penicillin), Antiseptics, Antacids', 'Soaps vs Detergents: Soap = sodium salt of fatty acid', 'Biodegradable vs Non-biodegradable polymers'], recommendedBooks: ['NCERT Ch.15-16'], tips: 'Easy chapter — pure memorization. Make a table: Polymer → Monomer → Type → Use. Frequently asked in NEET.', weightage: '2-3 questions', difficulty: 'easy' },
        // INORGANIC CHEMISTRY — chapter-wise
        { id: 'nc-periodic', name: 'Periodic Table & Properties', ncertChapter: 'Class 11 Ch.3', keyConcepts: ['Modern periodic law: properties are periodic functions of atomic number', 'Blocks: s (Group 1-2), p (Group 13-18), d (Group 3-12), f (lanthanoids/actinoids)', 'Trends across period (L→R): Atomic radius ↓, IE ↑, EA ↑, EN ↑', 'Trends down group (T→B): Atomic radius ↑, IE ↓, EA ↓, EN ↓', 'Exceptions: Noble gas EA = 0, Fluorine EA < Chlorine (small size)', 'Diagonal relationship: Li-Mg, Be-Al, B-Si'], recommendedBooks: ['NCERT Ch.3', 'JD Lee'], tips: 'Trends + exceptions = guaranteed 2-3 questions. Draw the periodic table and mark all trends with arrows.', weightage: '2-3 questions', difficulty: 'easy' },
        { id: 'nc-bonding', name: 'Chemical Bonding', ncertChapter: 'Class 11 Ch.4', keyConcepts: ['Ionic bond: metal + non-metal, electron transfer', 'Covalent bond: non-metal + non-metal, electron sharing', 'VSEPR theory: predicts shape from electron pairs (BP + LP)', 'Shapes: Linear(2), Trigonal planar(3), Tetrahedral(4), TBP(5), Octahedral(6)', 'Hybridization: sp(180°), sp²(120°), sp³(109.5°), sp³d(90°/120°), sp³d²(90°)', 'Molecular Orbital Theory: σ and π bonds, Bond order = (Nb-Na)/2', 'Hydrogen bonding: F-H...F, O-H...O, N-H...N'], importantFormulas: ['Bond order = (Nb - Na)/2'], recommendedBooks: ['NCERT Ch.4', 'OP Tandon', 'JD Lee'], tips: 'VSEPR + Hybridization = most asked. Practice predicting shape from formula: count electron pairs around central atom.', weightage: '3-4 questions', difficulty: 'medium' },
        { id: 'nc-sblock', name: 's-Block Elements', ncertChapter: 'Class 11 Ch.10', keyConcepts: ['Group 1 (Alkali metals): Li, Na, K, Rb, Cs — most reactive metals', 'Group 2 (Alkaline earth): Be, Mg, Ca, Sr, Ba', 'Anomalous behavior of Li and Be (diagonal relationship)', 'Important compounds: NaOH (caustic soda), Na₂CO₃ (washing soda), NaHCO₃ (baking soda)', 'Plaster of Paris: CaSO₄·½H₂O, Portland cement composition'], recommendedBooks: ['NCERT Ch.10'], tips: 'Mostly NCERT-based. Know compounds + uses + anomalous behavior. Quick revision chapter.', weightage: '1-2 questions', difficulty: 'easy' },
        { id: 'nc-pblock', name: 'p-Block Elements', ncertChapter: 'Class 11 Ch.11 + Class 12 Ch.7', keyConcepts: ['Group 13 (Boron family): B₂H₆ (diborane), BF₃ (Lewis acid), AlCl₃', 'Group 14 (Carbon family): Diamond vs Graphite, Silicones, CO vs CO₂', 'Group 15 (Nitrogen family): NH₃, HNO₃, N₂O₅, Phosphorus allotropes', 'Group 16 (Oxygen family): Ozone, H₂SO₄ (king of chemicals), SO₂', 'Group 17 (Halogens): HF (weak acid but strongest HX bond), Interhalogen compounds', 'Group 18 (Noble gases): XeF₂, XeF₄, XeF₆ structures'], recommendedBooks: ['NCERT Ch.11 + Class 12 Ch.7', 'JD Lee', 'VK Jaiswal'], tips: 'HIGHEST weightage in Inorganic (6-8 questions). Read NCERT line by line — every compound, every reaction, every use. Make group-wise comparison tables.', weightage: '6-8 questions', difficulty: 'medium' },
        { id: 'nc-dblock', name: 'd and f Block Elements', ncertChapter: 'Class 12 Ch.8', keyConcepts: ['Transition elements: Variable oxidation states, colored ions, complex formation', 'Properties: Metallic character, high MP/BP, catalytic activity, paramagnetism', 'Important compounds: KMnO₄ (Mn: +7), K₂Cr₂O₇ (Cr: +6)', 'Lanthanoid contraction: gradual decrease in atomic/ionic radius across 4f series', 'Actinoids: Radioactive, U and Th most important'], recommendedBooks: ['NCERT Ch.8', 'JD Lee'], tips: 'KMnO₄ and K₂Cr₂O₇ reactions in acidic/basic/neutral medium — learn all three. Lanthanoid contraction consequences.', weightage: '2-3 questions', difficulty: 'medium' },
        { id: 'nc-coordination', name: 'Coordination Compounds', ncertChapter: 'Class 12 Ch.9', keyConcepts: ['Werner\'s theory: central metal + ligands = coordination sphere', 'IUPAC nomenclature: anionic ligand (-o), neutral (aqua, ammine)', 'Coordination number = number of ligand atoms bonded to metal', 'Isomerism: Geometric (cis/trans), Optical, Ionization, Linkage', 'Crystal Field Theory (CFT): t₂g and eg splitting, CFSE', 'Spectrochemical series: I⁻ < Br⁻ < Cl⁻ < F⁻ < OH⁻ < H₂O < NH₃ < en < CN⁻ < CO'], recommendedBooks: ['NCERT Ch.9', 'JD Lee', 'VK Jaiswal'], tips: 'Nomenclature + Isomerism = most asked. Practice naming 20+ coordination compounds. Know spectrochemical series by heart.', weightage: '2-3 questions', difficulty: 'hard' },
      ]
    }
  ]
};
